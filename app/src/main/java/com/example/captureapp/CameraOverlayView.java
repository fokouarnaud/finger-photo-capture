...
public class CameraOverlayView extends View {
    public final static float PADDING = 0.1f;
    ...
    private Rect overlaySimpleRect = new Rect();
    ...
    public void onDraw(Canvas canvas) {
        ...
        overlaySimpleRect.set(Math.round(getWidth() * PADDING),
                Math.round(getHeight() * PADDING),
                Math.round(getWidth() * (1.0f - PADDING)),
                Math.round(getHeight() * (1.0f - PADDING)));
